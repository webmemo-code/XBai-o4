...
def main():
    ...
    test_parser.add_argument("--use_score", action="store_true", help="Whether add score module.")
    ...
    if args.use_score:
        score_src_file = os.path.join(args.local_dir, 'score_module.pt')
        score_dest_file = os.path.join(args.target_dir, 'score_module.pt')
